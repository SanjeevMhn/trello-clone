  ...
  return (
    <div className="wrapper bg-slate-900 ">
      <nav className="main-nav flex items-center justify-between py-[1.5rem] gap-[2.5rem]">
        <h2 className="text-[2rem] text-white">Trello Page</h2>
        ...
        <ul className="menu-list flex items-center gap-[1rem]">
          <li className="item">
            <button
              type="button"
              className="w-[4rem] h-[4rem] rounded-full group hover:bg-slate-500 flex items-center justify-center cursor-pointer"
            >
              <svg
